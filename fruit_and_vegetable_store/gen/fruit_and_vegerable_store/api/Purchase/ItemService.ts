...
class ItemService {
    ...
    public getAll(_: any, ctx: any) {
        try {
            const options: ItemEntityOptions = {
    ...
    public create(entity: any) {
        try {
            ...
            response.setHeader("Content-Location", "/services/ts/fruit_and_vegetable_store/gen/fruit_and_vegerable_store/api/Purchase/ItemService.ts/" + entity.Id);
    ...
    public getById(_: any, ctx: any) {
        try {
            ...
            if (entity) {
                ...
                HttpUtils.sendResponseNotFound("Item not found");
            }
        } catch (error: any) {
            this.handleError(error);
        }
